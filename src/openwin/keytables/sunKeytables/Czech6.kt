#ident "@(#)Czech6.kt 1.1	98/11/17 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-6 (USB) Czech keyboard (Czech6.kt) 
######################################################################
# Important Note:
#
...
48	RN	XK_parenright	XK_parenleft	XK_multiply
...
51	RN	XK_uring	XK_quotedbl	XK_dollar
52	RN	XK_section	XK_exclam	XK_ssharp

#Below two lines are for multiple hardware support.
49      RN      XK_dead_diaeresis       XK_apostrophe   XK_currency
50	RN	XK_dead_diaeresis	XK_apostrophe	XK_currency
