# /* @(#)US101A_Sun.kt	35.2 05/13/97 SunSoft */
#ident "@(#)US101A_Sun.kt	1.6 92/01/02 KEYTABLES SMI"
#
...
#
# Keytable for a Sun U.S. 101A keyboard (US101A_Sun.kt)
#
# -------------------  SUN COMPATIBLE LAYOUT  -----------------------
#
######################################################################
# Important Note:
#
...
22      NN      XK_L5		XK_L5		XK_Print      	SunXK_Sys_Req
23      NN      XK_L7		XK_L7		XK_Scroll_Lock
1       NN      XK_L1           XK_L1           XK_Pause	XK_Break
...
25	NN	XK_L8		XK_L8		XK_Insert
97	NN	XK_L6		XK_L6		XK_Home
51	NN	XK_L3		XK_L3 		XK_Prior
...
118	RN	XK_L10		XK_L10		XK_Delete
26	NN	XK_L9		XK_L9		XK_End
73	NN	XK_L4		XK_L4		XK_Next
...
120	NN	XK_Meta_L	# Use Left Alt key as Meta_L
121	RN	XK_space
122	NN	XK_Alt_L	# Use Right Alt key as Alt_L

19	NN	SunXK_Compose	# Use Control_R as Compose
