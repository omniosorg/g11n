MODMAP
#ident "@(#)Macedonia6.kt 1.1	2006/04/12 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-6 (USB) Macedonian keyboard (Macedonia6.kt) 
######################################################################
# Important Note:
#
...
39	RN	XK_0		XK_equal
45	RN	XK_apostrophe	XK_question
46	RN	XK_plus		XK_asterisk
42	RN	XK_BackSpace
...
48	RN	XK_bracketright	XK_braceright	XK_Macedonia_gje	XK_Macedonia_GJE
...
52      RN      XK_section      XK_section      XK_Macedonia_kje    XK_Macedonia_KJE
...
# NOTE: For Macedonia, we're using the AltGraph key as a state switching key
