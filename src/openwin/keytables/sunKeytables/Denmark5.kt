# /* @(#)Denmark5.kt	35.1 09/01/94 SunSoft */
#ident "@(#)Denmark5.kt	1.2 91/08/01 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-5 Danish keyboard (Denmark5.kt) 
######################################################################
# Important Note:
#
...
50	RN	XK_Delete	XK_Delete 	XK_KP_Separator
