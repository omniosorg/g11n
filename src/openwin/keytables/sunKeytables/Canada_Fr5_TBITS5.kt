#ident "@(#)Canada_Fr5_TBITS5.kt	1.2 92/12/17 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-5 Canadian-French keyboard (Canada_Fr5_TBITS5.kt)
######################################################################
# Important Note:
#
...
84	RN	XK_K
85	RN	XK_L
86      RN      XK_semicolon    XK_colon	XK_degree
87      RN      XK_Egrave
88      RN      XK_Agrave
89	RN	XK_Return
...
108     RN      XK_period       XK_quotedbl	XK_greater
109     RN      XK_eacute	XK_Eacute
110	NN	XK_Shift_R
...
19	NN	XK_Alt_L
120	NN	XK_Meta_L
121	RN	XK_space	XK_space	XK_nobreakspace
67	NN	SunXK_Compose
...
#############################   Dummy Key   ################################
#
# Following key does not exist on keyboard, but has been
# added for firmware to produce ^ and ` characters.
#

15	NN	XK_asciicircum	XK_quoteleft
