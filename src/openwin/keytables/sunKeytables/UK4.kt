...
# /* @(#)UK4.kt	35.1 09/01/94 SunSoft */
#ident "@(#)UK4.kt	1.1 91/06/26 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-4 British keyboard (UK4.kt) 
######################################################################
# Important Note:
#
...
29 	NN	XK_Escape
30 	RN 	XK_1 		XK_exclam 	XK_brokenbar
31 	RN 	XK_2 		XK_at
...
40 	RN 	XK_minus 	XK_underscore 	XK_notsign
