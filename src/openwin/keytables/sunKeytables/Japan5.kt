# /* @(#)Japan5.kt	35.2 01/27/00 SunSoft */
#ident "@(#)Japan5.kt	1.3 91/07/30 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-5 Japanese keyboard (Japan5.kt) 
######################################################################
# Important Note:
#
...
39	RN	XK_0		NoSymbol	XK_kana_WA	XK_kana_WO
