#ident "@(#)Finnish6.kt 1.1	98/11/17 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-6 (USB) Swedish keyboard (Sweden6.kt) 
######################################################################
# Important Note:
#
...
19	RN	XK_P
47	RN	XK_Aring
48	RN	SunXK_FA_Diaeresis	XK_asciicircum  XK_asciitilde
