...
# /* @(#)UK5_Hobo.kt	35.1 09/01/94 SunSoft */
#ident "@(#)UK5_Hobo.kt	1.1 91/07/12 KEYTABLES SMI"
#
...
#
# Keytable for a Sun Type-5 United Kingdom keyboard (UK5_Hobo.kt) 
######################################################################
# Important Note:
#
...
42	RN	XK_quoteleft	XK_notsign	XK_brokenbar	
...
87	RN	XK_quoteright	XK_at
88	RN	XK_numbersign	XK_asciitilde
