...
#pragma ident "@(#)extern.h	3.5	00/10/05	SMI"

extern char *X_UNIX_FROM ;
...
extern char *target_printer ;    /* Printer name whose PDL to be output */
extern char *mpconf_path ;	 /* User specified config. path */
...
extern int dup_stdout_des ;  /* duplicate stdout descriptor */
...
extern bool use_mp_conf ;    /* Use mp.conf evenif prolog.ps present */
...
extern bool nodecor ;        /* Set if we are printing without decorations */
...
extern bool print_spool;	/* File to be spooled to a printer */
#endif /* _EXTERN_H */
