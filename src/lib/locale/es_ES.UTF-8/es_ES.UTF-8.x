...
# All rights reserved.
#
# Method file for es_ES.UTF-8 and any other Unicode locales.
#
#
#ident	"@(#)es_ES.UTF-8.x 1.6	00/10/30 SMI"
#
...
# coming from the methods_es_ES.UTF-8.so.2 shared object.
#
eucpctowc	"__u32_to_dense_u32_utf8"	"localelib" "." "methods_es_ES.UTF-8.so.2"
