...
# All rights reserved.
#
# Method file for de_DE.UTF-8@euro and any other Unicode locales.
#
#
#ident	"@(#)de_DE.UTF-8@euro.x 1.6	00/10/30 SMI"
#
...
# coming from the methods_de_DE.UTF-8@euro.so.2 shared object.
#
eucpctowc	"__u32_to_dense_u32_utf8"	"localelib" "." "methods_de_DE.UTF-8@euro.so.2"
