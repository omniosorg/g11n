...
# All rights reserved.
#
# Method file for fr_BE.UTF-8@euro and any other Unicode locales.
#
#
#ident	"@(#)fr_BE.UTF-8@euro.x 1.6	00/10/30 SMI"
#
...
# coming from the methods_fr_BE.UTF-8@euro.so.2 shared object.
#
eucpctowc	"__u32_to_dense_u32_utf8"	"localelib" "." "methods_fr_BE.UTF-8@euro.so.2"
